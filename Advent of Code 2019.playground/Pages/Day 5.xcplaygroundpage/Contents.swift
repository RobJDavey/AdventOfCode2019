 ...
 */
assert(process([1002,4,3,4,33]) == 0)
assert(process([3,0,4,0,99], input: 1) == 1)
assert(process([1101,100,-1,4,0]) == 0)

let instructions = getInput().components(separatedBy: ",").compactMap(Int.init)

let answer1 = process(instructions, input: 1)
 ...
 */
assert(process([3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,
1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,
999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99], input: 7) == 999)

assert(process([3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,
1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,
999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99], input: 8) == 1000)

assert(process([3,21,1008,21,8,20,1005,20,22,107,8,21,20,1006,20,31,
1106,0,36,98,0,0,1002,21,125,20,4,20,1105,1,46,104,
999,1105,1,46,1101,1000,1,20,4,20,1105,1,46,98,99], input: 9) == 1001)

let answer2 = process(instructions, input: 5)
