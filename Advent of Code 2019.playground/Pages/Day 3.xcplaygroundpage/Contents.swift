 ...
 *
    ...
    2. `U98,R91,D20,R16,D67,R40,U7,R15,U6,R7` = distance  `135`
 
 *What is the Manhattan distance* from the central port to the closest intersection?
 */
let directions = getInput()
    .components(separatedBy: .newlines)
    .map { $0.components(separatedBy: ",").map(RelativeDirection.init) }

let answer1 = part1(directions)
 ...
 *
    1. `R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51`
    2. `U98,R91,D20,R16,D67,R40,U7,R15,U6,R7` = `410` steps
 
 *What is the fewest combined steps the wires must take to reach an intersection?*
 */
let answer2 = part2(directions)
