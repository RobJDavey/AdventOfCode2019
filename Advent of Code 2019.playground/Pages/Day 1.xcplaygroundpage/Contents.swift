 ...
 */
assert(calculateCompoundFuel(14) == 2)
assert(calculateCompoundFuel(1969) == 966)
assert(calculateCompoundFuel(100756) == 50346)

let answer2 = part2()
print("Part 2: \(answer2)")
assert(answer2 == 4907345)
